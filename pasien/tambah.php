   ...
   <center>
    ...
    <div class="card-body">
         <form method="post" action="proses-tambah.php">
                ...
                <button type="submit" class="btn btn-outline-success" name="simpan">Tambah</button>&nbsp&nbsp<button type="simpan" class="btn btn-outline-info" name="kembali">Kembali</button>
